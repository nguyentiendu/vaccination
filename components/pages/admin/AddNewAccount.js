            ...
            <CustomButtonModal isOpen={openModalCreate} closeModal={handleCloseCreate}>
                ...
                <div>
                    ...
                    <div className={VCManagementCSS.wrapperDateTime}>
                        ...
                        <div>
                            {
                                dataNewAccount.value.id_role!=="2" ? "" : 
                                <div className={VCManagementCSS.wrapperInput}>
                            <label
                                className="block uppercase text-blueGray-600 text-xs font-bold mb-3"
                                htmlFor="grid-password"
                            ...
                            <CustomInput
                                defaultValue={dataNewAccount.value.id_place}
                                className={VCManagementCSS.customInput}
                                type="number"
                                required
                                id="outlined-required"
                                ...
                                onChange={(event) => {
                                    setDataNewAccount(state => ({
                                        ...
                                        error: {...state.error, id_place: validationInvalid(event.target.value)}
                                    }))
                                }}
                            />
                            <span
                                className="text-red-500 text-sm">{dataNewAccount.error.id_place ? "Không được bỏ trống" : ""}</span>
                        </div>
                            }
                        </div>
                    </div>
