...
const columns = [
    {field: 'id_vaccination_records', headerName: 'ID', width: 100},
    {field: 'id_vaccine', headerName: 'Tên vacxin', width: 200},
    {field: 'id_vaccination_place', headerName: 'Điểm tiêm', width: 240},
    {field: 'injection_date', headerName: 'Ngày tiêm', width: 200},
    {
        field: 'blood_pressure', headerName: 'Huyết áp', width: 150, renderCell: (params) => {
            return <Chip color="success" label={params.row.Quantity + " mmHg"} variant="outlined"/>
        },
    },
    {
        field: 'level_response', headerName: 'Mức độ phản ứng', width: 220, renderCell: (params) => {
            return <Chip color="success" label={params.row.Time} variant="outlined"/>
        },
    },
    {
        field: 'heart_rate', headerName: 'Nhịp tim', width: 180, renderCell: (params) => {
            return <Chip color="success" label={params.row.Time + " lần/phút"} variant="outlined"/>
        },
    },
